...
def extract_continuous_time_industrial(raw_dir, cohort_path, output_path, max_len=243):
    """
    ...
    subject_list = con.execute("SELECT subject_id FROM cohort").df()['subject_id'].tolist()
...
COHORT_PATH = "/home/users/nus/e1582377/MedFlow/data/processed_12/mimiciv_cohort.csv"
OUTPUT_NPY = "/home/users/nus/e1582377/MedFlow/data/processed_12/mimiciv_con_time_12.npy"
